...
def test_guided_visit_fields_are_typed_and_complete(guided_detail_context):
    ...
    assert visit["camera_result_summary"] == {
        ...
        "estimated_muac_cm": None,
        "height_range_lower_cm": None,
        "height_range_upper_cm": None,
        "weight_range_lower_kg": None,
        "weight_range_upper_kg": None,
        "muac_range_lower_cm": None,
        "muac_range_upper_cm": None,
        "estimated_stunting_status": "Moderate Stunting",
