...
class GuidedVisitService:
    ...
    def append_camera_result(
        ...
        result = CameraResult(
            ...
            estimated_muac_cm=submission.estimated_muac_cm,
            height_source=submission.height_source,
            weight_source=submission.weight_source,
            muac_source=submission.muac_source,
            height_range_lower_cm=submission.height_range_lower_cm,
            height_range_upper_cm=submission.height_range_upper_cm,
            weight_range_lower_kg=submission.weight_range_lower_kg,
            weight_range_upper_kg=submission.weight_range_upper_kg,
            muac_range_lower_cm=submission.muac_range_lower_cm,
            muac_range_upper_cm=submission.muac_range_upper_cm,
