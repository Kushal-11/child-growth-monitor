...
class CameraResult(Base):
    ...
    estimated_muac_cm = Column(Float, nullable=True)
    height_source = Column(String(100), nullable=True)
    weight_source = Column(String(100), nullable=True)
    muac_source = Column(String(100), nullable=True)
    height_range_lower_cm = Column(Float, nullable=True)
    height_range_upper_cm = Column(Float, nullable=True)
    weight_range_lower_kg = Column(Float, nullable=True)
    weight_range_upper_kg = Column(Float, nullable=True)
    muac_range_lower_cm = Column(Float, nullable=True)
    muac_range_upper_cm = Column(Float, nullable=True)
