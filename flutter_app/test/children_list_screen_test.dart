...
void main() {
  testWidgets('shows only the owner\'s non-archived children from local db',
      (tester) async {
    final db = AppDatabase.forTesting(NativeDatabase.memory());
    final dao = ChildDao(db);
    await dao.createChild(
        name: 'Mine', dateOfBirth: '2024-01-01', sex: 'M', ownerUserId: 1);
    await dao.createChild(
        name: 'Theirs', dateOfBirth: '2024-01-01', sex: 'F', ownerUserId: 2);
