...
# ML wasting detection paths.
# Keras/pickle files are local training artifacts. Production inference uses
# the tracked TFLite/JSON bundle so a clean checkout matches Flutter exactly.
...
ML_TRAINING_SCALER_PATH  = ML_MODELS_DIR / "feature_scaler.pkl"
ML_TRAINING_LABEL_ENCODER_PATH = ML_MODELS_DIR / "label_encoder.pkl"
...
ML_SCALER_PATH             = ML_MODELS_DIR / "feature_scaler.json"
ML_LABEL_ENCODER_PATH      = ML_MODELS_DIR / "label_encoder.json"
ML_MODEL_MANIFEST_PATH     = ML_MODELS_DIR / "model_manifest.json"
